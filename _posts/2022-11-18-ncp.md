...
### 이해 | 정리
<br>
과거에는 기본적으로 PC 1대에는 1개의 OS만이 구동할 수 있었다. 하지만 PC의 리소스를 효율적으로 사용하기 위해 1대의 PC에서 여러 개의 Guest OS를 사용하기 위해서 가상화 시스템이란걸 사용하기 시작했다.<br>

![13대](https://velog.velcdn.com/images%2Fghldjfldj%2Fpost%2Fb593ea1e-a53c-4d05-b752-42a49803fce7%2Fimage.png){: width="100" height="100"}
**1세대** 가상화 시스템은 APP 위에 마치 PC와 같은 시스템을 구현시키기 위해 에뮬레이터를 이용하였고, Guest OS는 이러한 에뮬레이터를 통해 가상화된 H/W 위에 설치되어서 PC의 H/W와 신호를 주고받을 수 없었고 그렇다 보니 Guest OS의 속도가 느리고 리소스의 낭비가 상대적으로 크다.<br>

![23대](https://velog.velcdn.com/images%2Fghldjfldj%2Fpost%2F2b99f818-de72-4379-995b-4387a2f1771b%2Fimage.png){: width="100" height="100"}
**2세대**에 들어와서는 **하이퍼바이저**라는 플랫폼이 등장하였다. Guest OS는 기존의 APP 위에서 에뮬레이터를 통해 가상화된 H/W 가 아닌 PC의 H/W 와 하이퍼바이저를 통해 직접 신호를 주고받을 수 있게 되었다. 그로 인해 Guest OS의 작동 속도가 이전에 비하면 매우 빨라졌고 PC의 리소스 이전보다 효율적으로 사용할 수 있게 되었다.<br>

![33대](https://velog.velcdn.com/images%2Fghldjfldj%2Fpost%2F12491043-66be-487d-8154-740cd0fb4ffb%2Fimage.png){: width="100" height="100"}
