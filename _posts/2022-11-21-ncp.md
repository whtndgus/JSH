...
### 2.  Git 로컬 저장소 생성,업로드 및 버전 관리
[링크](https://jsh961015.notion.site/22-11-18-597c8a85095442ccbef19fc7d33709f1){:target="_blank"}
...
- **.gitignore [** [https://inpa.tistory.com/entry/GIT-⚡️-gitignore-자동-생성#.gitignore_자동생성_사이트](https://inpa.tistory.com/entry/GIT-%E2%9A%A1%EF%B8%8F-gitignore-%EC%9E%90%EB%8F%99-%EC%83%9D%EC%84%B1#.gitignore_%EC%9E%90%EB%8F%99%EC%83%9D%EC%84%B1_%EC%82%AC%EC%9D%B4%ED%8A%B8) **]**
    - git 저장소에 저장하지 않을 대상을 지정하는 파일
    - 주로 도구를 실행하면 자동으로 생성되는 파일들을 지정함( 예; /class , /exe , bin/ , 등등 )
    - 기존 프로젝트 저장소에 설정된 파일을 가져와서 편집
    - .gitignore 파일을 자동 생성하여 주는 사이트를 이용하는 방법 [ .gitignore :  [https://www.toptal.com/developers/gitignore](https://www.toptal.com/developers/gitignore) ]
...
![Untitled](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/8a9fcbd5-3ddb-4985-8193-f328388627b3/Untitled.png)
